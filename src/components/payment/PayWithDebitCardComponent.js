...
export default class PayWithDebitCardComponent extends Component {
    ...
    onSelect(item, index): void {
        ...
        this.props.onChangeDebitCard(item)
    }
    ...
    render() {
        return (
            <View style = { this.stylesView.general } accessibilityLabel = "viewGeneral">
                ...
                <TouchableOpacity style = { this.stylesView.title } onPress = { () => this.onIsDebitCard() } accessibilityLabel = "touchableDebitCard" >
                    <TouchableOpacity onPress = { () => this.onIsDebitCard() } accessibilityLabel = "touchableOpacity">
                        <ImageBackground style = { this.stylesView.imageBackground }
                                         imageStyle = { this.state.isDebitCard ? this.stylesImage.checkSelected : this.stylesImage.checkUnselected }
                                         source = { Images.icons.checkBorder }
                                         accessibilityLabel = "imageBackground">
                            <Image style = { this.stylesImage.check }
                                   source = { this.state.isDebitCard ? Images.icons.check : null }
