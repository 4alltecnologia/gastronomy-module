...
import { NO_UNITIES_WARNING_STRINGS as WarningStrings } from "../../languages"
import { FontFamily, FontWeight, BackgroundColor } from "../../theme/Theme"

export default class NoUnitiesWarning extends PureComponent {
        ...
        return (
            <View style = { this.stylesView.general } accessibilityLabel = "viewGeneral">
                <View style = { this.stylesView.content } accessibilityLabel = "viewContent">
                    ...
                    <TouchableOpacity style = { this.stylesButton.refreshOffers } onPress = { () => this.props.tryAgain() } accessibilityLabel = "viewButtonTryAgain">
                        <LinearGradient colors = { [BackgroundColor.primary, BackgroundColor.gradient] } style = { this.stylesButton.buttonRefreshOffersGradient }>
                            <Text style = { this.stylesText.buttonTitle } accessibilityLabel = "textButtonTryAgain">
