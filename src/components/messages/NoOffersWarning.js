...
import { NO_OFFERS_WARNING_STRINGS as WarningStrings } from "../../languages"
import { FontFamily, FontWeight, BackgroundColor } from "../../theme/Theme"

export default class NoOffersWarning extends PureComponent {
            ...
            <View style = { this.stylesView.general } accessibilityLabel = "viewGeneral">
                <View style = { this.stylesView.content } accessibilityLabel = "viewContent">
                    ...
                    <Text style = { this.stylesText.message } accessibilityLabel = "textMessage">
                        { WarningStrings.message }
                    </Text>
                    <TouchableOpacity style = { this.stylesButton.refreshOffers } onPress = { () => this.props.refreshOffers() } accessibilityLabel = "viewButtonRefreshOffers">
                        <LinearGradient colors = { [BackgroundColor.primary, BackgroundColor.gradient] } style = { this.stylesButton.buttonRefreshOffersGradient }>
                            <Text style = { this.stylesText.buttonTitle } accessibilityLabel = "textButtonRefreshOffers">
                                { WarningStrings.buttonTitle }
                            </Text>
                        </LinearGradient>
                    </TouchableOpacity>
                </View>
