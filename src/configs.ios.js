...
const API_DATA_MKTP = {
    // urlBaseHomolog: "http://192.168.54.57:8080/mktplace/v1",
...
function setupModule(dictionary, isHomolog) {
    ...
    ExternalMethods.setup(isHomolog ? ENVIRONMENTS.Homologation : ENVIRONMENTS.Production, "IOS_GASTRONOMY-MODULE_1", "1.0.0", newDictionary)
}
